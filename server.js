...
function seedIfEmpty() {
  ...
  if (parkingCount.c === 0) {
    const parkings = [
      ...
      { id: 4001, name: 'Паркинг "Гурко"', location: 'ул. "Гурко"', totalSpots: 80, availableSpots: 18, price: '3.00 EUR/час', rating: 4.1, reviews: 42, description: 'Паркинг в близост до ул. Гурко.', lat: 42.4989, lng: 27.4683, amenities: '["Осветление","Паркомати"]', status: 'available' },
      { id: 4002, name: 'Паркинг "Опера"', location: 'около Операта', totalSpots: 60, availableSpots: 12, price: '3.50 EUR/час', rating: 4.4, reviews: 88, description: 'Паркинг за посетители на оперния театър.', lat: 42.4990, lng: 27.4684, amenities: '["Осветление"]', status: 'available' },
      { id: 4003, name: 'Паркинг "БСУ"', location: 'до БСУ', totalSpots: 120, availableSpots: 30, price: '2.80 EUR/час', rating: 4.0, reviews: 60, description: 'Паркинг близо до Бургаския свободен университет.', lat: 42.4991, lng: 27.4685, amenities: '["Достъп за инвалиди","Паркомати"]', status: 'available' },
      { id: 4004, name: 'Паркинг к-с "Славейков"', location: 'ж.к. Славейков / ВХТИ', totalSpots: 90, availableSpots: 14, price: '3.20 EUR/час', rating: 3.9, reviews: 34, description: 'Квартален паркинг в района на ВХТИ.', lat: 42.4992, lng: 27.4686, amenities: '["Осветление"]', status: 'available' },
      { id: 4005, name: 'Паркинг "Изгрев бл. 7"', location: 'ж.к. Изгрев, бл. 7', totalSpots: 40, availableSpots: 8, price: '2.50 EUR/час', rating: 3.6, reviews: 12, description: 'Квартален паркинг до бл. 7 в Изгрев.', lat: 42.4993, lng: 27.4687, amenities: '["Осветление"]', status: 'available' },
      { id: 4006, name: 'Паркинг "Пиргос"', location: 'ж.к. Лазур', totalSpots: 70, availableSpots: 20, price: '3.80 EUR/час', rating: 4.2, reviews: 48, description: 'Паркинг в зоната на Лазур.', lat: 42.4994, lng: 27.4688, amenities: '["Паркомати","Осветление"]', status: 'available' },
      { id: 4007, name: 'Паркинг "КОЦ"', location: 'ул. Средна гора', totalSpots: 55, availableSpots: 10, price: '3.00 EUR/час', rating: 4.0, reviews: 22, description: 'Паркинг до Културно-образователния център.', lat: 42.4995, lng: 27.4689, amenities: '["Осветление"]', status: 'available' },
      { id: 4008, name: 'Паркинг "ИХ България"', location: 'ул. България', totalSpots: 85, availableSpots: 26, price: '3.50 EUR/час', rating: 4.1, reviews: 36, description: 'Паркинг до ИХ България.', lat: 42.4996, lng: 27.4690, amenities: '["Паркомати"]', status: 'available' },
      { id: 4009, name: 'Паркинг Burgas Plaza', location: 'Burgas Plaza', totalSpots: 200, availableSpots: 60, price: '4.00 EUR/час', rating: 4.3, reviews: 210, description: 'Клиентски паркинг на Burgas Plaza.', lat: 42.4997, lng: 27.4691, amenities: '["Лифт","Паркомати"]', status: 'available' },
      { id: 4010, name: 'Паркинг Mr. Bricolage', location: 'Mr. Bricolage зона', totalSpots: 150, availableSpots: 40, price: '3.50 EUR/час', rating: 4.0, reviews: 98, description: 'Клиентски паркинг на Mr. Bricolage.', lat: 42.4998, lng: 27.4692, amenities: '["Паркомати"]', status: 'available' },
      { id: 4011, name: 'Паркинг Морска гара', location: 'Морска гара', totalSpots: 120, availableSpots: 20, price: '4.00 EUR/час', rating: 4.2, reviews: 132, description: 'Паркинг при Морската гара.', lat: 42.4999, lng: 27.4693, amenities: '["Охрана"]', status: 'available' },
      { id: 4012, name: 'Паркинг Пристанище', location: 'Пристанище Бургас', totalSpots: 140, availableSpots: 40, price: '4.50 EUR/час', rating: 4.1, reviews: 75, description: 'Зона за посетители на пристанището.', lat: 42.5000, lng: 27.4694, amenities: '["Осветление"]', status: 'available' },
      { id: 4013, name: 'Паркинг "Магазия 1"', location: 'Магазия 1', totalSpots: 60, availableSpots: 10, price: '3.00 EUR/час', rating: 3.8, reviews: 18, description: 'Паркинг до Магазия 1.', lat: 42.5001, lng: 27.4695, amenities: '["Паркомати"]', status: 'available' },
      { id: 4014, name: 'Паркинг Автогара Юг', location: 'Централна автогара – юг', totalSpots: 160, availableSpots: 22, price: '3.20 EUR/час', rating: 3.9, reviews: 44, description: 'Паркинг при автогара (юг).', lat: 42.5002, lng: 27.4696, amenities: '["WC","Осветление"]', status: 'available' },
      { id: 4015, name: 'Паркинг ЖП Гара', location: 'Централна жп гара', totalSpots: 200, availableSpots: 12, price: '3.80 EUR/час', rating: 4.0, reviews: 150, description: 'Паркинг в района на жп гара.', lat: 42.5003, lng: 27.4697, amenities: '["WC","Осветление"]', status: 'available' },
      { id: 4016, name: 'Паркинг "Казино"', location: 'Морска градина – Казино', totalSpots: 120, availableSpots: 30, price: '4.00 EUR/час', rating: 4.3, reviews: 98, description: 'Паркинг в зоната на Морското казино.', lat: 42.5004, lng: 27.4698, amenities: '["Подземен","Охрана"]', status: 'available' },
      { id: 4028, name: 'Паркинг "Мол Галерия"', location: 'Мол Галерия Бургас', totalSpots: 300, availableSpots: 95, price: '4.50 EUR/час', rating: 4.3, reviews: 340, description: 'Голям паркинг при Мол Галерия.', lat: 42.5016, lng: 27.4710, amenities: '["Лифт","Паркомати"]', status: 'available' },
      { id: 4029, name: 'Паркинг "Кауфланд Славейков"', location: 'Кауфланд Славейков', totalSpots: 180, availableSpots: 40, price: '3.80 EUR/час', rating: 4.0, reviews: 190, description: 'Паркинг при Кауфланд в Славейков.', lat: 42.5017, lng: 27.4711, amenities: '["Паркомати"]', status: 'available' },
      { id: 4030, name: 'Паркинг "Кауфланд Изгрев"', location: 'Кауфланд Изгрев', totalSpots: 160, availableSpots: 36, price: '3.80 EUR/час', rating: 4.0, reviews: 132, description: 'Паркинг при Кауфланд в Изгрев.', lat: 42.5018, lng: 27.4712, amenities: '["Паркомати"]', status: 'available' },
      { id: 4039, name: 'Паркинг "Декатлон"', location: 'Декатлон зона', totalSpots: 250, availableSpots: 80, price: '4.00 EUR/час', rating: 4.2, reviews: 200, description: 'Голям паркинг при Декатлон.', lat: 42.5027, lng: 27.4721, amenities: '["Паркомати","Осветление"]', status: 'available' },
      { id: 4040, name: 'Паркинг "Метро"', location: 'Метро зона', totalSpots: 300, availableSpots: 120, price: '4.50 EUR/час', rating: 4.3, reviews: 240, description: 'Голям търговски паркинг при Метро.', lat: 42.5028, lng: 27.4722, amenities: '["Паркомати","Охрана"]', status: 'available' },
      { id: 4042, name: 'Паркинг "Триа Сити"', location: 'Триа Сити Център', totalSpots: 260, availableSpots: 90, price: '4.20 EUR/час', rating: 4.3, reviews: 210, description: 'Голям паркинг при Триа Сити Център.', lat: 42.5030, lng: 27.4724, amenities: '["Лифт","Паркомати"]', status: 'available' },
    ];
